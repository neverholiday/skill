...
description: Critically challenge code, configuration, or plans by identifying edge cases, potential flaws, and alternative approaches in an interactive, sequential grilling format. Use when you want to red-team or stress-test a file, plan, or design decision.
---
...
- `[ ]` **Analyze against the Checklist**: Apply the corresponding specialized checklist below to identify the top 3-5 critical risks, hidden assumptions, or alternative paths.
- `[ ]` **Sequential Challenge Loop**:
    - Do NOT output all findings in a single large list.
    - Select the **single most critical** risk or assumption first.
